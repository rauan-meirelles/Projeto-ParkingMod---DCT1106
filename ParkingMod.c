...
void menuSobre(void) {
    ...
    printf("///   Indisponíveis, Vagas para cada tipo de Veículo, Vagas Premium,        ///\n");
    printf("///   Preços por hora de cada tipo de vaga, entre outros, como o Lucro      ///\n");
    printf("///   final diário, Avaliação do cliente e Sugestões de melhoras.           ///\n");
    printf("///                                                                         ///\n");
    printf("///      Em desenvolvimento pelo aluno Rauan Meirelles Dantas de Araújo     ///\n");
    printf("///                                                                         ///\n");
    printf("///////////////////////////////////////////////////////////////////////////////\n");
    printf("\n");
}
